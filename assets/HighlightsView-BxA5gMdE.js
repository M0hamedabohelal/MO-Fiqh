...
غيّر إعدادات المتصفح ثم حاول مرة أخرى.`);return}d.document.write(u),d.document.close(),setTimeout(()=>d.print(),500)}var l=e(),u=({highlights:e,notes:u,lessons:d,onDeleteHighlight:f,onOpenLessonById:p})=>{let m=e.length>0||Object.values(u).some(e=>e&&String(e).trim());return(0,l.jsxs)(`div`,{className:`mt-4 mb-5`,children:[(0,l.jsxs)(`div`,{className:`d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4`,children:[(0,l.jsxs)(`h3`,{className:`mb-0 fw-bold`,style:{color:`var(--primary-color)`},children:[(0,l.jsx)(a,{className:`ms-2`}),` الفوائد المقتبسة`]}),m&&(0,l.jsxs)(`button`,{className:`btn btn-sm d-flex align-items-center shadow-sm`,style:{backgroundColor:`var(--badge-bg)`,border:`1px solid var(--border-color)`,borderRadius:`10px`,fontWeight:`bold`},onClick:()=>c({highlights:e,notes:u,lessons:d}),title:`طباعة أو حفظ PDF`,children:[(0,l.jsx)(n,{className:`ms-2`,size:18}),` تصدير الفوائد والملاحظات`]})]}),e.length===0?(0,l.jsx)(o,{icon:a,message:(0,l.jsxs)(`span`,{children:[`لا توجد فوائد مقتبسة حالياً.`,(0,l.jsx)(`br`,{}),`حدد أي نص في المسائل لحفظه هنا.`]})}):(0,l.jsx)(`div`,{className:`d-flex flex-column gap-3`,children:e.slice().reverse().map(e=>{let n=d.find(t=>t.id===e.lessonId),a=e.bookName||n?.bookName||`كتاب غير محدد`,o=e.chapterName||n?.chapterName||`باب غير محدد`,c=e.title||n?.title||`مسألة غير محددة`;return(0,l.jsxs)(`div`,{className:`custom-card p-3 p-md-4 shadow-sm`,children:[(0,l.jsxs)(`div`,{className:`d-flex align-items-start gap-2 mb-3`,children:[(0,l.jsxs)(`p`,{className:`mb-0 flex-grow-1`,style:{fontSize:`1.1rem`,lineHeight:`1.85`},children:[`"`,e.text,`"`]}),(0,l.jsx)(`button`,{className:`btn btn-outline-danger btn-sm rounded-circle d-flex align-items-center justify-content-center flex-shrink-0`,style:{width:`34px`,height:`34px`,minWidth:`34px`,marginTop:`2px`},onClick:()=>f(e.id),title:`حذف الفائدة`,children:(0,l.jsx)(t,{size:15})})]}),(0,l.jsx)(s,{title:`فائدة مقتبسة`,text:e.text,sheikhComment:``,isSmall:!0}),(0,l.jsx)(`hr`,{style:{opacity:.1}}),(0,l.jsxs)(`div`,{className:`d-flex justify-content-between align-items-center flex-wrap gap-2`,children:[(0,l.jsxs)(`span`,{className:`badge badge-custom text-muted d-flex flex-column align-items-start py-2 px-3`,style:{maxWidth:`65%`},children:[(0,l.jsxs)(`span`,{className:`text-truncate w-100`,children:[(0,l.jsx)(i,{className:`ms-2`}),` `,c]}),(0,l.jsxs)(`small`,{className:`mt-1 text-truncate w-100`,children:[a,` > `,o]})]}),(0,l.jsxs)(`button`,{className:`btn btn-sm btn-light text-primary d-flex align-items-center`,style:{fontWeight:`bold`,flexShrink:0},onClick:()=>p(e.lessonId),children:[`الذهاب للمسألة `,(0,l.jsx)(r,{className:`me-1`})]})]})]},e.id)})})]})};export{u as default};